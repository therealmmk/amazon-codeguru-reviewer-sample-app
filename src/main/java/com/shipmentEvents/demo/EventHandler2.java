...
public class EventHandler2 implements RequestHandler<ScheduledEvent, String> {
    ...
    private void processShipmentUpdates(final LambdaLogger logger) throws InterruptedException {
        ...
        final AmazonS3 s3Client = EventHandler2.getS3Client();
        ...
        EventHandler2.getS3Client().putObject(Constants.SUMMARY_BUCKET, summaryUpdateName, latestStatusForTrackingNumber.toString());
        ...
        if (EventHandler2.getS3Client().doesObjectExist(Constants.SUMMARY_BUCKET, summaryUpdateName)) {
